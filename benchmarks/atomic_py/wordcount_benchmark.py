"""Word count via reduce_by_key — atomic-py counterpart to
benchmarks/spark/wordcount_benchmark.py.

Same corpus layout and same Python closures as the Spark script, so this
isolates engine overhead from raw language speed. Requires atomic-py built
into this venv:
...
def main() -> None:
    ...
    print(
        "RESULT engine=atomic-py workload=wordcount total_words={} lines={} vocab={} "
