...
pub struct ApproxListener<U, R, E>
where
    ...
    R: Clone + Debug + Send + Sync + 'static,
{
    ...
    start_time: Instant,
    timeout: Duration,
    failure: Mutex<Option<PartialJobError>>,
    total_tasks: usize,
...
impl<E, U: Debug, R> ApproxListener<U, R, E>
where
    E: ApproximateEvaluator<U, R>,
    R: Clone + Debug + Send + Sync + 'static,
{
    ...
    pub async fn get_result(&self) -> Result<PartialResult<R>, PartialJobError> {
